...
// + String(req.query.bookTitle) + ", " + String(req.query.bookAuthor) + ", " + String(req.query.bookGenre) +
var SQL_INSERT = "INSERT INTO Book (Title, Author, Genre) VALUES (Temporal Void, Peter, Fantasy)";
